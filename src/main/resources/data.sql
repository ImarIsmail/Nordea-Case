...
INSERT INTO books (id, isbn, title, author, total_copies, available_copies) VALUES
    (1, '9780143127741', 'Dune', 'Frank Herbert', 3, 1);

INSERT INTO books (id, isbn, title, author, total_copies, available_copies) VALUES
    (2, '9780132350884', 'Clean Code', 'Robert C. Martin', 2, 2);

INSERT INTO books (id, isbn, title, author, total_copies, available_copies) VALUES
    (3, '9780201633610', 'Design Patterns', 'Erich Gamma, Richard Helm, Ralph Johnson, John Vlissides', 1, 0);
...
INSERT INTO members (id, full_name, email) VALUES
    (3, 'Nina Andersen', 'nina@example.com');
...
INSERT INTO loans (id, book_id, member_id, checked_out_at, returned_at, status) VALUES
    (3, 3, 3, TIMESTAMP '2026-07-05 14:00:00', NULL, 'ACTIVE');

INSERT INTO loans (id, book_id, member_id, checked_out_at, returned_at, status) VALUES
    (4, 1, 3, TIMESTAMP '2026-07-05 14:00:00', NULL, 'ACTIVE');
